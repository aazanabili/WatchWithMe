...
والتقديم (`play`/`pause`/`seek`). يسجل Playwright trace/video عند الفشل؛ ويتطلب الاختبار
توفر YouTube والـiframe فعلياً، لذلك يفشل إذا منعت قيود التضمين الخارجية تشغيل المقطع.
